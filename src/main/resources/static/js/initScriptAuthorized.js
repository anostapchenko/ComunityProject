...
function start() {
    ...
    let parent = mainDiv.parentNode
    let container = document.createElement("div")
    container.classList.add("container")
    let row = document.createElement("div")
    row.classList.add("row")

    parent.replaceChild(container, mainDiv)
    container.appendChild(row)
    let sidebarCol = document.createElement("div")
    sidebarCol.classList.add("col-2")
    //let mineCol = document.createElement("div")
    sidebarCol.appendChild(createSideBar())
    row.appendChild(sidebarCol)
    row.appendChild(mainDiv)

    // let mainDivHeight = Math.max(mainDiv.clientHeight, mainDiv.scrollHeight, mainDiv.offsetHeight)
    // let headingWidth = Math.max(header.clientWidth, header.scrollWidth, header.offsetWidth) - 1
    // if (mainDivHeight < document.documentElement.clientHeight){
    //     const headingHeight = Math.max(header.clientHeight)
...
function createHeader() {
    ...
    header.innerHTML = `
        <div class="navbar-brand">
            <svg width="100px" height="35px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 375">
                <path class="logo"
        ...
        <div class="col-1">
            <a class="btn svg-btn" href="#">
                <svg width="25" height="25" viewBox="0 0 20 18">
...
function createFooter() {
    ...
    footer.innerHTML = `
        <div class="row">
            <div class="col block">
                <h6>BLOCK 1</h6>
                <div class="mdiv">Item 1</div>
                <div class="mdiv">Item 2</div>
                <div class="mdiv">Item 3</div>
                <div class="mdiv">Item 4</div>
            </div>
            <div class="col block">
                <h6>BLOCK 2</h6>
                <div class="mdiv">Item 1</div>
...
function createSideBar() {
    ...
    sideBar.innerHTML = `
        <div class="sticky-top sidebar-menu-offset">
