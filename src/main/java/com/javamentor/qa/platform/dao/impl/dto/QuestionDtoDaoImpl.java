...
public class QuestionDtoDaoImpl implements QuestionDtoDao {
    ...
    public QuestionDto getQuestionDtoDaoById(Long id) {
        ...
        Integer ID = (Integer) entityManager.createQuery("SELECT r.count FROM Reputation r")
                .getSingleResult();
//        Query query = entityManager.createQuery("SELECT r.count FROM Reputation r WHERE r.id =: id", Reputation.class)
//                .setParameter("id", id);
