...
import com.qa.platform.dao.abstracts.dto.BookMarksDtoDao;
...
public class BookMarksDtoDaoImpl implements BookMarksDtoDao {
    ...
    public List<BookMarksDto> getAllBookMarksInUserProfile(Long id) {
        return (List<BookMarksDto>) entityManager.createQuery("select new com.qa.platform.models.dto.BookMarksDto (" +
                        "q.id, q.title ," +
