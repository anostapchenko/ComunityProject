package com.qa.platform.dao.impl.pagination.tagdto;
...
public class TagPageDtoDaoAllTagsByPopularImpl implements PageDtoDao<TagViewDto> {
    ...
    public List<TagViewDto> getPaginationItems(PaginationData properties) {
        ...
        return entityManager.createQuery("select new com.qa.platform.models.dto.question.TagViewDto " +
                                            ...
                                            "from Tag t where t.name like concat('%',:filter,'%')   order by t.questions.size desc", TagViewDto.class)
