...
import com.qa.platform.dao.abstracts.dto.UserDtoDao;
...
public class UserDtoDaoImpl implements UserDtoDao {
    ...
    public List<UserProfileQuestionDto> getAllUserProfileQuestionDtoById(Long id) {
        return entityManager.createQuery("select  new com.qa.platform.models.dto.UserProfileQuestionDto(" +
                "q.id,q.title," +
    ...
    public Optional<UserDto> findUserDto(Long id) {
        ...
        return SingleResultUtil.getSingleResultOrNull(entityManager.createQuery("SELECT NEW com.qa.platform.models.dto.UserDto(" +
                        "u.id," +
                        "u.email," +
                        "u.fullName," +
                        "u.imageLink," +
    ...
    public List<UserProfileQuestionDto> getAllUserProfileQuestionDtoByUserIdWhereQuestionIsDeleted(Long id) {
        return (List<UserProfileQuestionDto>) entityManager.createQuery("select " +
                        "new com.qa.platform.models.dto.UserProfileQuestionDto (" +
                        "q.id," +
                        "q.title ," +
